...
void DrawCharacters::DrawNumber(int max, float x, float y, int s)
{
...
void DrawCharacters::DrawHP(float x, float y, int type, int s)
{
...
int DrawCharacters::Convert(char c)
{
	return c - '0';
}