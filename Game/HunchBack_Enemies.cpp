...
void HunchBack_Enemies::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
HunchBack_Enemies::HunchBack_Enemies()
{
	this->hopping = false;
	this->healthPoint = 2;
	vx = vy = 0;
...
void HunchBack_Enemies::SetState(int state)
{
...
void HunchBack_Enemies::GetBoundingBox(float& left, float& top, float& right, float& bottom)
{
	left = x;
	top = y;
